...
<html lang="en">
  <head>
    ...
    <title>Markaled-Diğer Departman</title>
	<meta charset="utf-8">
  ...
  <body class="bg-light">
    ...
    <div class="container">
      <div class="py-5 text-center">
        ...
        <h2 class="h4"><i>Diğer Departman</i></h2>
		</div>
		<div class="row">
        ...
        <form method="POST" action="">
			...
			<div class="row">
				<table class="table table-bordered table-dark">
					...
					<?php
					//declare @id2 int;
					//Set @id2 =Select id2 from kullanici_bilgileri
					//$id2    = $_GET['id2'];
					...
					$sorgu_listele="SELECT 
						    ...
						    updated_at 
						        ...
						        IN
						            ( SELECT
						                 id2 
						                FROM kullanici_bilgileri where id2='1')";//2,1..yazınca oluyor


/*Select * from TABLO order by id desc limit 0,10*/

/*FROM kullanici_bilgileri where id2='1'*/

/*FROM kullanici_bilgileri where id2='".@$_POST["id2"]."'*/

/*FROM kullanici_bilgileri id2=(kullanici_bilgileri.id2=siparis.id2)*/
